...
class Subscription(TimestampedModel):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["current_period_end"], name="ix_subscriptions_period_end"),
        ]
...
class WebhookEvent(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["provider", "event_type"], name="ix_webhook_events_type"),
        ]
...
class UsageCounter(TimestampedModel):
    ...
    subscription = models.ForeignKey(
        Subscription, on_delete=models.SET_NULL, null=True, blank=True, related_name="usage_counters"
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["user", "period_start"], name="uq_usage_counter_user_period"),
        ]
        indexes = [
            models.Index(fields=["user", "period_end"], name="ix_usage_counters_user_end"),
        ]
