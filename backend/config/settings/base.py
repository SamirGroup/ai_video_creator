...
# Core
# ---------------------------------------------------------------------------
SECRET_KEY = env.str("SECRET_KEY", default=env.str("DJANGO_SECRET_KEY", default="unsafe-dev-key-change-me"))
...
FIELD_ENCRYPTION_ACTIVE_KEY_VERSION = env.int("FIELD_ENCRYPTION_ACTIVE_KEY_VERSION", default=1)
...
GOOGLE_OAUTH_REDIRECT_URI = env.str(
    "GOOGLE_OAUTH_REDIRECT_URI", default="http://localhost:8000/api/v1/oauth/youtube/callback"
)
GOOGLE_ADSENSE_REDIRECT_URI = env.str(
    "GOOGLE_ADSENSE_REDIRECT_URI", default="http://localhost:8000/api/v1/oauth/adsense/callback"
)
...
AWS_REKOGNITION_SECRET_ACCESS_KEY = env.str("AWS_REKOGNITION_SECRET_ACCESS_KEY", default="")
...
OPENAI_MODERATION_API_KEY = env.str("OPENAI_MODERATION_API_KEY", default="") or OPENAI_API_KEY
...
OPENROUTER_APP_TITLE = env.str("OPENROUTER_APP_TITLE", default="AI YouTube Content Ecosystem")
...
SCRIPT_TITLE_SIMILARITY_THRESHOLD = env.float("SCRIPT_TITLE_SIMILARITY_THRESHOLD", default=0.9)
...
MODERATION_AUTO_REJECT_ON_BLOCK = env.bool("MODERATION_AUTO_REJECT_ON_BLOCK", default=False)
...
YOUTUBE_QUOTA_TIMEZONE = env.str("YOUTUBE_QUOTA_TIMEZONE", default="America/Los_Angeles")
# FR-54: resumable upload chunking. Must be a multiple of 256 KiB.
YOUTUBE_UPLOAD_CHUNK_SIZE_BYTES = env.int("YOUTUBE_UPLOAD_CHUNK_SIZE_BYTES", default=8 * 1024 * 1024)
YOUTUBE_UPLOAD_MAX_CHUNK_RETRIES = env.int("YOUTUBE_UPLOAD_MAX_CHUNK_RETRIES", default=5)
# FR-59: how long after publish the processing/rejection status is polled.
YOUTUBE_POST_PUBLISH_WINDOW_HOURS = env.int("YOUTUBE_POST_PUBLISH_WINDOW_HOURS", default=24)
...
CONTENT_NICHES = [
    "travel", "cooking", "motivation", "technology", "finance", "health",
    "education", "science", "history", "gaming", "lifestyle", "business",
    "productivity", "entertainment", "sports", "nature", "diy", "parenting",
]
SUPPORTED_CONTENT_LANGUAGES = ["en"]  # Q3: English only in MVP
...
PIPELINE_EXPECTED_DURATION_MINUTES = env.int("PIPELINE_EXPECTED_DURATION_MINUTES", default=90)
...
SCHEDULER_NOTIFY_DEDUPE_SEC = env.int("SCHEDULER_NOTIFY_DEDUPE_SEC", default=24 * 60 * 60)
