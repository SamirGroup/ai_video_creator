...
urlpatterns = [
    ...
    path("revenue/statements", views.RevenueShareStatementListView.as_view(), name="statements"),
    path(
    ...
    path("admin/finance/export", views.AdminFinanceExportView.as_view(), name="admin-finance-export"),
]
